...
namespace danentang.Controllers
{
    ...
    {
        private readonly JsonFileService _fs;// biến dùng để thao tác 
        private readonly string _path = "data/incidents.json";// dường dẫn tệp lưu trữ dư liệu

        public IncidentController(JsonFileService fs) { _fs = fs; }//hàm khởi tạo sử dụng Dependency Injection để truyền JsonFileService vào.

        [HttpGet]// phương thức get
